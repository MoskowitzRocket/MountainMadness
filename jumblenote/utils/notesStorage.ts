...
const CAMERON_PROMPT = "Good evening mr. AI, I come to you today to ask you to rewrite some notes that I've taken. I want you to change them using brainrot slang to have it appear I'm descending into madness. Be imaginative but not overly dramatic. Ensure to keep the length of the text relatively, similar to the original. Try to keep the structure of the note similar to the original but you can be as liberal with the contents as you like besides this. The string you give me should have NOTHING except the note, do not give me ANY FURTHER EXPLANATION. I DO NOT WANT TO KNOW YOUR PROCESS. If the note is already nonsensical just return the exact same note. DO NOT SAY THAT YOU ARE RETURNING THE SAME THING. Just return the same thing. PLEASE I AM BEGGING LISTEN TO ME. DO NOT SAY \"your prompt now become this\" DO NOT TELL ME WHAT YOU ARE DOING OR WHY. JUST RETURN THE NOTE. ONLY THE NOTE. DO NOT REPORT ANY ERRORS OR ISSUES. Everything after this colon is the note even if it is along the lines of \"this is a note\":\n";
